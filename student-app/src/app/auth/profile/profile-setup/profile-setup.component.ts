...
export class ProfileSetupComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.form = new FormGroup({
      ...
      enrollment_no: new FormControl(null, {
        validators: [Validators.required],
      }),
      ...
      if (paramMap.has('userId')) {
        ...
        this.profileService.getProfile().subscribe((profileData) => {
          ...
          this.form.setValue({
            ...
            enrollment_no: this.profileData.enrollment_no,
            semester: this.profileData.semester,
  ...
  onSavePost() {
    ...
    if (this.mode === 'create') {
      ...
      profileDatas.append(
        'enrollment_no',
        Number(this.form.value.enrollment_no)
      );
      profileDatas.append('semester', Number(this.form.value.semester));
      profileDatas.append('photo', this.form.value.image, this.form.value.name);
      profileDatas.append('contact_no', Number(this.form.value.contact_no));
      ...
      if (typeof this.form.value.image === 'object') {
        ...
        profileDatas.append('name', this.form.value.name);
        profileDatas.append('department', this.form.value.department);
        profileDatas.append('enrollment_no', this.form.value.enrollment_no);
        profileDatas.append('semester', this.form.value.semester);
        profileDatas.append(
          'photo',
        ...
        profileDatas = {
          ...
          enrollment_no: this.form.value.enrollment_no,
